...
<div class="container">
    ...
    <div class="panel panel-default">
        ...
        <div class="list-group">
            <!--for-->
            <?php $__FOR_START_18612__=0;$__FOR_END_18612__=5;for($i=$__FOR_START_18612__;$i < $__FOR_END_18612__;$i+=1){ ?><a href="#" class="list-group-item">使用for标签循环了<?php echo ($i+1); ?>次了</a><?php } ?>
        </div>
    </div>
    <!--PHP标签-->
    <div class="panel panel-default">
